...
enum DLPErrCode : int32_t {
    ...
    DLP_CREDENTIAL_ERROR_SET_POLICY_FAIL = -309,
    DLP_CREDENTIAL_ERROR_GET_POLICY_FAIL = -310,
    DLP_CREDENTIAL_ERROR_REMOVE_POLICY_FAIL = -311,
    ...
    DLP_KV_DATA_STORAGE_KEY_EXISTED_ERROR = -601,
    DLP_KV_DATA_STORAGE_KEY_NOT_EXISTS_ERROR = -602,
    DLP_KV_DATE_INFO_EMPTY_ERROR = -603,
    DLP_COMMON_CHECK_KVSTORE_ERROR = -604,
    DLP_COMMON_DELETE_KEY_FROM_KVSTORE_ERROR = -605,
};
}  // namespace DlpPermission
}  // namespace Security
}  // namespace OHOS
