...
enum DLPErrCode : int32_t {
    ...
    DLP_SERVICE_ERROR_URI_EMPTY = -71,
    DLP_SERVICE_ERROR_UNLOAD_ERROR = -72,
    ...
    DLP_PARSE_ERROR_BMS_ERROR = -121,
    DLP_PARSE_ERROR_GET_ACCOUNT_FAIL = -122,
    DLP_PARSE_ERROR_NOT_SUPPORT_FILE_TYPE = -123,
    DLP_PARSE_ERROR_ACCOUNT_PERSONAL = -124,
    DLP_PARSE_ERROR_GENERATE_FILEID_ERROR = -125,
    ...
    DLP_FUSE_ERROR_OPERATE_FAIL = -207,
    ...
    DLP_CREDENTIAL_ERROR_SET_ENTERPRISE_POLICY_FAIL = -315,
    DLP_CREDENTIAL_ERROR_ALLOWED_OPEN_COUNT_INVALID = -316,
    ...
    DLP_DEVICE_ERROR_CAPABILITY_NOT_SUPPORTED_EMULATOR = -800,
    DLP_DEVICE_ERROR_CAPABILITY_NOT_SUPPORTED = -801,

    DLP_HAP_DISCONN_ERROR = -810,
    DLP_IPC_PARAMS_ERROR = -811,
    DLP_IPC_DISMATCH_DESCRIPTOR = -812,
    DLP_IPC_GETREMOTE_ERROR = -813,
    DLP_IPC_SEND_REQUEST_ERROR = -814,
    DLP_IPC_CALLBACK_ERROR = -815,
    DLP_CREATE_PIXELMAP_ERROR = -816,
