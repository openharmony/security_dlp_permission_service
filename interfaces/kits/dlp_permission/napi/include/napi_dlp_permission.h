...
private:
    ...
    static napi_value UnSubscribeOpenDlpFile(const napi_env env, const napi_value thisVar, napi_ref &callback);
    ...
    static bool ParseStartDLPManagerParams(napi_env env, napi_callback_info cbInfo,
