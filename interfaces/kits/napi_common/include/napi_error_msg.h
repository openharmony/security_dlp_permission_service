...
enum JsErrorCode : int32_t {
    ...
    ERR_JS_CAPABILITY_NOT_SUPPORTED_EMULATOR = 804,
    ...
    ERR_JS_DLP_SET_ENTERPRISE_POLICY_FAIL = 19100021,
    ERR_JS_DLP_ALLOWED_OPEN_COUNT_INVALID = 19100022,

    // dlptransparentenc
    ERR_JS_DLP_USERID_INCONSISTENT = 19110005,
    ERR_JS_DLP_NOT_ENTERPRISE_WORKSPACE = 19110006,
};
