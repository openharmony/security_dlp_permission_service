...
static const std::unordered_map<int32_t, std::string> JS_ERROR_MSG_MAP = {
    ...
    { ERR_JS_API_ONLY_FOR_SANDBOX_ERROR, "No permission to call this API, which is available only for DLP sandbox applications." },
    { ERR_JS_API_NOT_FOR_SANDBOX_ERROR, "No permission to call this API, which is available only for non-DLP sandbox applications." },
