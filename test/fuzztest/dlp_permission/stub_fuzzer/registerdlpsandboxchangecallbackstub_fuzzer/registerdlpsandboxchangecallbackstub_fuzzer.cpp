...
#include "registerdlpsandboxchangecallbackstub_fuzzer.h"
#include <iostream>
#include <string>
#include <thread>
#include <vector>
...
static void FuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(DlpPermissionServiceInterfaceCode::REGISTER_DLP_SANDBOX_CHANGE_CALLBACK);
    MessageParcel reply;
