...
#include "setsandboxconfigstub_fuzzer.h"
#include <iostream>
#include <string>
#include <thread>
#include <vector>
...
static void FuzzTest(const uint8_t* data, size_t size)
{
    ...
    if (!datas.WriteString(testStr)) {
        return;
    }
    uint32_t code = static_cast<uint32_t>(IDlpPermissionServiceIpcCode::COMMAND_SET_SANDBOX_APP_CONFIG);
    MessageParcel reply;
