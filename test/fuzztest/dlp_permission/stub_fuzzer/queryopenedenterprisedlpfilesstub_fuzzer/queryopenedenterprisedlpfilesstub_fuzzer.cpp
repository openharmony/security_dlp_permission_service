...
#include "queryopenedenterprisedlpfilesstub_fuzzer.h"
...
static void FuzzTest(const uint8_t* data, size_t size)
{
    ...
    uint32_t code = static_cast<uint32_t>(IDlpPermissionServiceIpcCode::COMMAND_QUERY_OPENED_ENTERPRISE_DLP_FILES);
    MessageParcel reply;
...
{
    OHOS::QueryOpenedEnterpriseDlpFilesFuzzTest(data, size);
    return 0;
}
