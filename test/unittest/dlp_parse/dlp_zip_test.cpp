...
// /**
//  * @tc.name: CheckUnzipFileInfo005
//  * @tc.desc: CheckUnzipFileInfo abnormal test
//  * @tc.type: FUNC
//  * @tc.require:
//  */
// HWTEST_F(DlpZipTest, CheckUnzipFileInfo005, TestSize.Level0)
// {
//     DLP_LOG_INFO(LABEL, "CheckUnzipFileInfo005");
...
//     res = CheckUnzipFileInfo(fd);
//     ASSERT_EQ(false, res); // fail at FILE_NAME_SET find
...
// /**
//  * @tc.name: CheckUnzipFileInfo007
//  * @tc.desc: CheckUnzipFileInfo normal test
//  * @tc.type: FUNC
//  * @tc.require:
//  */
// HWTEST_F(DlpZipTest, CheckUnzipFileInfo007, TestSize.Level0)
// {
//     DLP_LOG_INFO(LABEL, "CheckUnzipFileInfo007");
...
//     DlpCMockCondition condition;
//     condition.mockSequence = {true, false, true, false, true};
//     SetMockConditions("unzGetCurrentFileInfo64", condition);
//     SetMockCallback("unzGetCurrentFileInfo64",
//         reinterpret_cast<CommonMockFuncT>(UnzGetFileInfoReply));
