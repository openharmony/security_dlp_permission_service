...
public:
    DlpAbilityAdapter(ReceiveDataCallback &callback);
    int32_t HandleGetWaterMark(int32_t userId, WaterMarkInfo &waterMarkInfo,
        std::shared_mutex &waterMarkInfoMutex, std::condition_variable_any &waterMarkInfoCv);
