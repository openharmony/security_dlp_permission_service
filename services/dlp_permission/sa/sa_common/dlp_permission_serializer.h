...
private:
    ...
    int32_t DeserializeGroupInfo(const unordered_json& infoJson, GroupInfo& groupInfo);
    int32_t DeserializeGroupList(const unordered_json& groupsJson, std::vector<GroupInfo>& groupList);
};
}  // namespace DlpPermission
}  // namespace Security
}  // namespace OHOS
