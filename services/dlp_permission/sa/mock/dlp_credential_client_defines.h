...
typedef enum {
    ...
    DLP_ERR_CONNECTION_VIP_RIGHT_EXPIRED = 0x00003008,
    DLP_ERR_CONNECTION_POLICY_PERMISSION_EXPIRED = 0x00003009,
    DLP_ERR_CONNECTION_NO_PERMISSION = 0x0000300A,
    DLP_ERR_CONNECTION_ALLOWED_OPEN_COUNT_INVALID = 0x0000300F,
